...
const ROOT_URL_SELF = 'https://grammateket.b-cdn.net/2.0.0/';
const ROOT_URL_GRAMMAR = 'https://grammateket.com/';
const CADUCEUS_URL = 'wss://caduceus.mv-nordic.com/caduceus/';
const SIGNOUT_URL = 'https://signon.vitec-mv.com/logout.php?return_to='+encodeURIComponent(ROOT_URL_GRAMMAR+'/logout.php')+'&sessionUid=';
