...
l10n.s = {
	da: {
		...
		BTN_GRAMMAR_SUPPORT: 'Få hjælp til Kukkuniaat',
		BTN_IGNORE: 'Ignorer',
		BTN_LOGIN: 'Login til Kukkuniaat',
		BTN_LOGOUT: 'Log ud',
		BTN_NEXT: 'Næste',
		...
		HDR_GRAMMAR: 'Kukkuniaat',
		HDR_GRAMMAR_ABOUT: 'Om Kukkuniaat',
		...
		HDR_SUBSCRIBE: 'Har du ikke Kukkuniaat eller Kommaforslag endnu?',
		HDR_SUPPORT_COPYRIGHT: 'Support &amp; Copyright',
		HDR_TTS: 'Oplæsning',
		HDR_WHAT_IS: 'Hvad er Kukkuniaat?',
		...
		MSO_INSTALLED_BODY: 'Kukkuniaat er nu installeret. Gå til fanen Hjem og klik på Kukkuniaat for at komme i gang.',
		MSO_INSTALLED_TITLE: 'Kom godt i gang med Kukkuniaat!',
		MSO_LEARNMORE_URL: 'https://tinodidriksen.com/spellers/',
		MSO_TOOLTIP: 'Klik for at åbne Kukkuniaat',
		POP_LOADING: '… loading …',
		POP_WORKING: '… arbejder …',
		TAB_COMMA: 'Kommaforslag',
		TAB_COMMA_GENERAL: 'Generelt',
		TAB_DICTIONARY: 'Brugerordbog',
		TAB_GRAMMAR: 'Kukkuniaat',
		...
		TXT_GRAMMAR_ABOUT: 'Kukkuniaat hjælper dig med at fange og fjerne stave- og slåfejl i dine tekster.',
		...
		TXT_WHAT_IS: 'Kukkuniaat hjælper dig med at fange og fjerne stave- og slåfejl i dine tekster.',
	},
	en: {
